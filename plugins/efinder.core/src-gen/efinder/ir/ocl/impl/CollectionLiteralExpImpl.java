 ...
 * </p>
 * <ul>
 *   <li>{@link efinder.ir.ocl.impl.CollectionLiteralExpImpl#getParts <em>Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CollectionLiteralExpImpl extends LiteralExpImpl implements CollectionLiteralExp {
	/**
	...
	public EList<OclExpression> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentEList<OclExpression>(OclExpression.class, this, OclPackage.COLLECTION_LITERAL_EXP__PARTS);
		}
		return parts;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OclPackage.COLLECTION_LITERAL_EXP__PARTS:
