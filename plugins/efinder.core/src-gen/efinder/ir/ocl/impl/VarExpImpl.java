 ...
 * </p>
 * <ul>
 *   <li>{@link efinder.ir.ocl.impl.VarExpImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarExpImpl extends OclExpressionImpl implements VarExp {
	/**
	...
	protected EClass eStaticClass() {
		return OclPackage.Literals.VAR_EXP;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OclPackage.VAR_EXP__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(VariableDeclaration newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.VAR_EXP__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OclPackage.VAR_EXP__VARIABLE:
