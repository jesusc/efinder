 ...
 * </p>
 * <ul>
 *   <li>{@link efinder.ir.ocl.impl.PropertyCallExpImpl#getName <em>Name</em>}</li>
 *   <li>{@link efinder.ir.ocl.impl.PropertyCallExpImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyCallExpImpl extends CallExpImpl implements PropertyCallExp {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.PROPERTY_CALL_EXP__NAME, oldName, name));
	}
