...
public abstract class AbstractIRVisitor<O, I>  {
	...
	public O visitOclConstraint(efinder.ir.ocl.OclConstraint self, I input) { return defaultHandler(self, input); }
	...
	if ( obj.eClass().getName().equals("OclConstraint") ) { return visitOclConstraint((efinder.ir.ocl.OclConstraint) obj, input); }
