...
public class IRCopier extends EcoreUtil.Copier {
	...
	public IRCopier(EObject object) {
		this.root = object;
	}
	...
	public IRCopier setRoot(EObject objectToCopy) {
	...
	public IRCopier bind(EObject key, EObject value) {
		bindMap.put(key, value);
		return this;
	}

	public IRCopier ignored(Collection<? extends EObject> toBeIgnored) {
		this.ignoredElements.addAll(toBeIgnored);
		return this;
	}

	public IRCopier bindAll(HashMap<? extends EObject, ? extends EObject> map) {
		bindMap.putAll(map);
		return this;
	}

	/*
	public IRCopier copyTypes(boolean b) {
		this.copyTypes = b;
		return this;
	}
	*/
	...
	public static EObject copySingleElement(EObject obj) {
	    IRCopier copier = new IRCopier(obj);
            ...
            if (eStructuralFeature.isChangeable() && !eStructuralFeature.isDerived())
            {
              ...
              else
              {
                ...
                // Added to handle the copy of some non-containment references                
                  ...
                  // This came from ATLCopier but it is possibly not needed here because IR models are self-contained
