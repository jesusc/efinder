 ...
 * </p>
 * <ul>
 *   <li>{@link efinder.ir.ocl.impl.RealLiteralExpImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealLiteralExpImpl extends LiteralExpImpl implements RealLiteralExp {
	...
	public void setValue(Double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.REAL_LITERAL_EXP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OclPackage.REAL_LITERAL_EXP__VALUE:
				return getValue();
		}
