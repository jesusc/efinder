 ...
 * </p>
 * <ul>
 *   <li>{@link efinder.ir.ocl.impl.StringLiteralExpImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralExpImpl extends LiteralExpImpl implements StringLiteralExp {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.STRING_LITERAL_EXP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OclPackage.STRING_LITERAL_EXP__VALUE:
				return getValue();
		}
