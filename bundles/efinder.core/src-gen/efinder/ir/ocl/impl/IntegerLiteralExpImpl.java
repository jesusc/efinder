 ...
 * </p>
 * <ul>
 *   <li>{@link efinder.ir.ocl.impl.IntegerLiteralExpImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerLiteralExpImpl extends LiteralExpImpl implements IntegerLiteralExp {
	...
	public void setValue(Integer newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.INTEGER_LITERAL_EXP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OclPackage.INTEGER_LITERAL_EXP__VALUE:
				return getValue();
		}
